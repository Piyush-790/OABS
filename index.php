      ...
      <div class="col-lg">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-text">Medanta Hospital, Kankarbagh Near New Bus Stand, Patna.</p>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
  // $(document). ready(function(){...});: This means the following code will run when the document (web page) is fully loaded and ready to be manipulated.
